 ...
 * @property integer $min_answers_to_success
 ...
 * @method integer             getMinAnswersToSuccess()    Returns the current record's "min_answers_to_success" value
 ...
 * @method Task                setMinAnswersToSuccess()    Sets the current record's "min_answers_to_success" value
...
abstract class BaseTask extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('min_answers_to_success', 'integer', null, array(
             'type' => 'integer',
             'notnull' => true,
             'default' => 0,
             ));
