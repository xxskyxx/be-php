...
class TeamStateForm extends BaseTeamStateForm
{
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setHelps(array(
        ...
        'ai_enabled' => '|<span class="info">При отключении каждое следующее задание должно назначаться вручную или выбраться самой командой.</span>|<span class="warn">Если задание не удастся выбрать, то автоматический выбор будет отключен.</span>'
    ));
  }
}
