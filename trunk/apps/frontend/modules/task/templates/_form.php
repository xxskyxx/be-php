...
<div class="comment">
  ...
  <ul>
    ...
    <li>
      <p>
        <span class="warn">Приоритеты из следующих полей являются взаимоисключающими:</span>
      </p>
      <ul>
        <li>"Приоритет когда свободно"</li>
        <li>"Приоритет когда выдано кому-либо"</li>
        <li>"Приоритет когда выполняется кем-либо"</li>
      </ul>
      <p>
        <span class="warn">Будет применен только один приоритет, соответствующий ситуации.</span> Остальные приоритеты будут суммироваться с выбранным.
      </p>        
    </li>
  </ul>
</div>
