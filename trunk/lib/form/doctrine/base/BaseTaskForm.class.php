...
abstract class BaseTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'priority_queued'        => new sfValidatorInteger(array('required' => false)),
      'priority_busy'          => new sfValidatorInteger(array('required' => false)),
      'priority_filled'        => new sfValidatorInteger(array('required' => false)),
      ...
      'min_answers_to_success' => new sfValidatorInteger(array('required' => false)),
