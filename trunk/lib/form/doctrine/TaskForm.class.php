...
class TaskForm extends BaseTaskForm
{
  ...
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setHelps(array(
        ...
        'locked' => 'При блокировке задания оно не выдается автоматически и не может быть выдано вручную.|<span class="warn">Включение блокировки не вызывает автоматического прекращения задания теми командами, которые уже получили это задание.</span>',
